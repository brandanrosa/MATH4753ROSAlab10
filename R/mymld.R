#' mymld
#'
#' an improved function that will increase accuracy of approximations to the `mymaxlik` function
#'
#' @param lfun function to be used
#' @param x x values for the function
#' @param param parameter values to be sampled
#' @param delta accuracy level
#'
#' @return a plot and a list
#' @export
#'
#' @importFrom graphics abline points axis layout
#'
#' @examples \dontrun{mymld(x = c(5,5,6,7),param=seq(0,100,length=1000),lfun=logpoiss)}
