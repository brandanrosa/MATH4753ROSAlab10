#' myNRML
#'
#' another take on the `mynewt` function, creates derivatives internally, given to us
#'
#'
#' @param x0 initial value
#' @param delta accuracy
#' @param llik log likelihood function
#' @param xrange range for x
#' @param parameter parameter to be sampled
#'
#' @return a plot and a list
#' @export
#'
#' @importFrom graphics abline points axis curve segments layout
#'
#' @examples \dontrun{myNRML(x0=0.99,delta=0.000001,llik="mean",xrange=c(0.01,0.99),parameter="p")}
